(function (global, factory) {
   ...
   */
   var SensorsFetchObjectsCropsRequest = /** @class */ (function () {
       function SensorsFetchObjectsCropsRequest(sensorId, ts, objectId, bucketFolder) {
           this.sensorId = sensorId;
           this.ts = ts;
           this.objectId = objectId;
   ...
   */
   ...
   var SensorsService = /** @class */ (function () {
        ...
        * @Return: ActionResponse
        */
       SensorsService.prototype.fetchObjectCrops = function (sensorId, ts, objectId, bucketFolder) {
           var _a;
           var params = new Array();
           if (sensorId != null) {
               params.push("sensorId=" + sensorId);
