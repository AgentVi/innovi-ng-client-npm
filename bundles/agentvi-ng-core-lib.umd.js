(function (global, factory) {
   ...
   */
   var Attribute = /** @class */ (function () {
       function Attribute(name, type, valString, valInt, valBool) {
           this.name = name;
           this.type = type;
   ...
   */
   var RuleSpec = /** @class */ (function () {
       function RuleSpec(behaviorType, ruleTypeName, objectTypes, isLineDrawing, dwellTime, minSpeed, peopleInGroup, clusterDistance, intervalTime, referenceCrop, objectHierarchy, sensorTypes) {
           this.behaviorType = behaviorType;
   ...
   */
   var AccountsServiceLogicalTreeRequest = /** @class */ (function () {
       function AccountsServiceLogicalTreeRequest(status, behaviorType, includeSensors, includeNonRecordingSensors) {
           this.status = status;
           this.behaviorType = behaviorType;
   ...
   */
   ...
   var AccountsService = /** @class */ (function () {
        ...
        */
       AccountsService.prototype.getLogicalTree = function (status, behaviorType, includeSensors, includeNonRecordingSensors) {
           var _a;
           var params = new Array();
           if (status != null) {
               params.push("status=" + status);
