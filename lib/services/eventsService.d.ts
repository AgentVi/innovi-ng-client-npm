...
export declare class EventsService {
     ...
     */
    exportFormat(folderId?: string, subFolders?: boolean, sensorId?: string, objectType?: ObjectTypeCode[], behaviorType?: BehaviorTypeCode[], severity?: SeverityTypeCode[], status?: EventStatusCode[], rule?: string[], from?: number, to?: number, sort?: string, format?: string, fields?: string[], fileName?: string, mimeType?: string): import("rxjs").Subscription;
    /**
     ...
     */
    getEventImage(id?: string, fileName?: string, mimeType?: string): import("rxjs").Subscription;
    /**
     * Get event clip [response content type: video/mp4]
     * @Return: StreamingOutput of the clip
     */
    getEventClip(id?: string, fileName?: string, mimeType?: string): import("rxjs").Subscription;
    /**
