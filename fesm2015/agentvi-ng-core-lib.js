...
class RuleSpec {
     ...
     * @param {?=} peopleInGroup
     */
    constructor(ruleType, behaviorTypes, objectTypes, isLineDrawing, dwellTime, peopleInGroup) {
