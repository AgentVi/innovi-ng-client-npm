...
class IntegrationStatusFindRequest {
    constructor(source, entityId, integrationTargetId, integrationActionId, from, to, sort, page, pageSize) {
        this.source = source;
        this.entityId = entityId;
...
class SearchEventExportRequest {
    constructor(sessionId, sensorId, objectType, tolerance, from, to, sort, format, fields, fileName) {
        this.sessionId = sessionId;
        this.sensorId = sensorId;
        this.objectType = objectType;
