...
/*
*/
class AppliancesServiceImportRequest {
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(CasesService, [{
        type: Injectable
    }], function () { return [{ type: CoreConfig, decorators: [{
                type: Inject,
                args: ['config']
