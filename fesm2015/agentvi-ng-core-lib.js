...
class EventsServiceFindInAreaRequest {
     ...
     * @param {?=} pageSize
     */
    constructor(folderId, searchArea, sensorId, objectType, behaviorType, severity, status, from, to, sort, page, pageSize) {
        this.folderId = folderId;
...
class EventsService {
     ...
     * @return {?}
     */
    findInArea(folderId, sensorId, objectType, behaviorType, severity, status, from, to, sort, page, pageSize) {
        /** @type {?} */
        const params = new Array();
        if (folderId != null) {
            params.push(`folderId=${folderId}`);
     ...
     * @return {?}
     */
    getEventsCountOvertime(folderId, sensorId, objectType, behaviorType, severity, status, from, to, interval, label) {
        /** @type {?} */
        const params = new Array();
        if (folderId != null) {
            params.push(`folderId=${folderId}`);
