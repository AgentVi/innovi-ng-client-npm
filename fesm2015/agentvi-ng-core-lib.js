...
/*
*/
class DeleteStaticWatchlistRequest {
    constructor(body) {
        this.body = body;
    }
}
...
/*
*/
class DeleteStaticWatchlistRequestBody {
    constructor(iD) {
        this.iD = iD;
    }
}
