...
/*
*/
class MembersServiceDomainSearchRequest {
    constructor(search, sort, page, pageSize) {
        this.search = search;
        this.sort = sort;
        this.page = page;
...
/*
*/
class QueryResponseOfDomainEntity extends QueryResponse {
}
