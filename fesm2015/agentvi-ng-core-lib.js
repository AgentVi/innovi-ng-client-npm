...
class ObjectInstance {
    constructor(timestamp, objectType, confidence, isStopped, colors, direction, dimension, boundingBox, speed, size, position, location, extendedModelResults) {
        this.timestamp = timestamp;
        this.objectType = objectType;
...
*/
class RuleSpec {
    constructor(behaviorType, ruleTypeName, objectTypes, isLineDrawing, dwellTime, minSpeed, peopleInGroup, clusterDistance, intervalTime, referenceCrop, objectHierarchy, sensorTypes, externalModel) {
        this.behaviorType = behaviorType;
...
class AccountsServiceLogicalTreeRequest {
    constructor(status, behaviorType, includeSensors, includeNonRecordingSensors) {
        this.status = status;
        this.behaviorType = behaviorType;
...
class EventsServiceExportRequest {
    constructor(folderId, subFolders, sensorId, objectType, behaviorType, severity, status, rule, tolerance, from, to, sort, format, fields, fileName) {
        this.folderId = folderId;
        this.subFolders = subFolders;
        this.sensorId = sensorId;
        this.objectType = objectType;
...
class EventsServiceFindInAreaRequest {
    constructor(folderId, searchArea, sensorId, objectType, behaviorType, severity, status, rule, tolerance, from, to, sort, page, pageSize) {
        this.folderId = folderId;
