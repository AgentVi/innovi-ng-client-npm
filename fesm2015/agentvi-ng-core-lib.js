...
class AccountsServiceLogicalTreeRequest {
    constructor(status, behaviorType, includeSensors, includeNonRecordingSensors, search) {
        this.status = status;
        this.behaviorType = behaviorType;
