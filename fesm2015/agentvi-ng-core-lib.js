...
*/
class InnoviClientConfig {
    /**
     * @param {?=} mapClient
     * @param {?=} mapKey
     * @param {?=} wMS
     */
    constructor(mapClient, mapKey, wMS) {
...
/*
*/
class EntityResponseOfInnoviClientConfig extends EntityResponse {
}
if (false) {
    /** @type {?} */
...
*/
class SocketSensorStatusNotification extends WebSocketMessageHeader {
}
if (false) {
    /** @type {?} */
