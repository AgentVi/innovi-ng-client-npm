...
(function (IntegrationStatusCode) {
    ...
    // Some of the integrations succeeded but not all [1] 
    IntegrationStatusCode[IntegrationStatusCode["PARTIAL"] = 1] = "PARTIAL";
    // All the integrations succeeded [2] 
    IntegrationStatusCode[IntegrationStatusCode["SUCCESS"] = 2] = "SUCCESS";
    // All the integrations failed [3] 
    IntegrationStatusCode[IntegrationStatusCode["FAILED"] = 3] = "FAILED";
