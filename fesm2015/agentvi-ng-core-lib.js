...
class GeoShape {
     ...
     * @param {?=} lineCrossDir
     */
    constructor(coordinates, lineCrossDir) {
        this.coordinates = coordinates;
        this.lineCrossDir = lineCrossDir;
    }
}
...
*/
class SensorShape extends RulePolygon {
}
if (false) {
    /** @type {?} */
