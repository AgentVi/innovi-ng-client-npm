...
class IntegrationActionFilter {
    constructor(sensorIds, ruleIds, objectTypes, behaviorTypes) {
...
/*
*/
class FoldersServiceChangeThresholdsRequest {
    constructor(id, body) {
        this.id = id;
        this.body = body;
    }
...
class SearchEventFindRequest {
    constructor(sessionId, sensorId, objectType, from, to, sort, page, pageSize) {
        this.sessionId = sessionId;
        this.sensorId = sensorId;
        this.objectType = objectType;
        this.from = from;
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(ApplianceDigitalIOService, [{
        type: Injectable
    }], function () { return [{ type: CoreConfig, decorators: [{
                type: Inject,
                args: ['config']
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(LicensesService, [{
        type: Injectable
    }], function () { return [{ type: CoreConfig, decorators: [{
                type: Inject,
                args: ['config']
...
class SysAuditLogService {
     ...
     * @Return: StreamContent
     */
    exportFormat(accountId, userId, from, to, item, itemType, sort, format, fields) {
        const params = new Array();
        if (accountId != null) {
            params.push(`accountId=${accountId}`);
        }
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(SysAuditLogService, [{
        type: Injectable
    }], function () { return [{ type: CoreConfig, decorators: [{
                type: Inject,
                args: ['config']
